...
plot(data3$Voltage ~ data3$DateTime,xlab="datetime",
    ylab="Voltage",pch=NA)
    lines(data3$Voltage ~ data3$DateTime)

plot(data3$Sub_metering_1 ~ data3$DateTime,pch=NA,xlab="",
    ylab="Energy sub metering")
    lines(data3$Sub_metering_1 ~ data3$DateTime)
...
plot(data3$Global_reactive_power ~ data3$DateTime,xlab="datetime",
